...
const FormControl = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      nombreEmpresa: Yup.string().required('El campo es requerido').max(20, 'El campo no puede tener mas de 20 caracteres'),
      nombreContacto: Yup.string().required('El campo es requerido').max(20, 'El campo no puede tener mas de 20 caracteres'),
      ...
      telefono: Yup.number(),
      consulta: Yup.string().required('El campo es requerido').max(300, 'El campo no puede tener mas de 300 caracteres')
    }),
    onSubmit: values =>{
      try {
