  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      nombreEmpresa: Yup.string()
        .required("El campo Nombre Empresa es requerido")
        .max(20, "El campo Nombre Empresa no puede tener mas de 20 caracteres"),
      nombreContacto: Yup.string()
        .required("El campo Nombre Contacto es requerido")
        .max(
          20,
          "El campo Nombre Contacto no puede tener mas de 20 caracteres"
        ),
      email: Yup.string()
      ...
      consulta: Yup.string()
        ...
        .max(300, "El campo Consulta no puede tener mas de 300 caracteres"),
    }),
    onSubmit: (values) => {
      try {
        emailjs
      ...
      <div className="flex flex-col lg:flex-row flex-wrap items-center justify-around w-full">
        <div className="flex flex-col w-4/5 lg:w-2/5">
          <input
            ...
            id="nombreEmpresa"
            name="nombreEmpresa"
            className={`mb-5 bg-transparent border-t-transparent border-l-transparent border-r-transparent ${
              formik.touched.nombreEmpresa && formik.errors.nombreEmpresa
                ? "placeholder:text-red-500 border-red-500"
                : "border-slate-800"
            } placeholder:text-slate-700   text-gray-900 text-xl border-2 focus:border-b-blue-500 focus:border-t-transparent focus:border-l-transparent focus:border-r-transparent focus:outline-none focus:ring-transparent block w-full p-2.5`}
            placeholder={`${
              formik.touched.nombreEmpresa && formik.errors.nombreEmpresa
        ...
        <input name="servicio" value={servicio} className="inputOculto" />
        <div className="flex flex-col w-4/5 lg:w-2/5">
          <textarea
            type="text"
            id="consulta"
            ...
            className={`mb-5 bg-transparent border-t-transparent border-l-transparent border-r-transparent ${
              formik.touched.consulta && formik.errors.consulta
                ? "placeholder:text-red-500 border-red-500"
                : "border-slate-800"
            } placeholder:text-slate-700   text-gray-900 text-xl border-2 focus:border-b-blue-500 focus:border-t-transparent focus:border-l-transparent focus:border-r-transparent focus:outline-none focus:ring-transparent block w-full lg:p-2.5`}
            placeholder={`${
              formik.touched.consulta && formik.errors.consulta
