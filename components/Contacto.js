...
const Contacto = () => {
  return (
    <div className="mr-10 ml-10 mt-5 mb-5">
        <h3 className="text-5xl pt-3 pb-7 mb-3 mt-10">Contactanos</h3>
        <form>
            <div className="flex-column items-center">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl w-full sm:w-auto px-5 py-2.5 mt-5 mb-10 text-center">Enviar</button>
            </div>
        </form>
    </div>
  )
