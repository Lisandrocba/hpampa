              ...
              <div className=" flex flex-col justify-center items-center rounded-xl">
                <div className="flex flex-row flex-wrap justify-around mx-4">
                  {producto
                    ...
                    producto.data.map((i) => {
                        return (
                          <div key={Math.random()} className="flex flex-col justify-around items-center mx-3 my-2  object-cover mb-10 bg-hpampa rounded-2xl py-5 px-5 text-slate-900">
                    ...
                    :
                      producto.data.map((i) => {
                        return (
                          <div key={Math.random()} className="flex flex-col justify-around items-center mx-3 my-2 w-40 object-cover mb-10 bg-hpampa rounded-2xl py-5 px-3 text-slate-900">
